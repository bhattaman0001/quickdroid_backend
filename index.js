...
connectMongoDB(
  "mongodb+srv://amanbhatt02:aman2001@cluster0.ey10qw7.mongodb.net/quickdroid_backend"
)
  .then(async () => {
    console.log("Database connected!!");
    /* // Access the collection directly and fetch all documents
    const collection = mongoose.connection.db.collection("files"); // Replace 'your_collection_name' with your actual collection name
